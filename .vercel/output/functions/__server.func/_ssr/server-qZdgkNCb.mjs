...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DhJUMAkM.mjs");
...
const manifest = {
  "bd91712aa12a864ae43341e860d6d1c64b91b59ae5ce60ea0dbdc10eee9819c1": {
    ...
    importer: () => import("./admin.functions-Df01yVH-.mjs")
  },
  "2acc0a4260be1ee504ae24740195058c8e1f85e9b507a2e2b13d779478779f01": {
    functionName: "submitRegistration_createServerFn_handler",
    importer: () => import("./registration.functions-DElpoqHJ.mjs")
  },
  "fe1fdea9f8e25ae158785c6c08d7511e61e559da75c78f8904993276882e26f8": {
    functionName: "getClassCounts_createServerFn_handler",
    importer: () => import("./registration.functions-DElpoqHJ.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-xCYX0l0n.mjs").then((n) => n.r),
    import("./start-Bmq-Z4Gz.mjs"),
