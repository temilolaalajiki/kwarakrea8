...
import { m as middle, a as map, b as many, c as choice, o as otherwise, f as flatten, d as option, l as leftAssoc2, e as ab, g as many1, t as token, h as abc, r as right, i as left } from "./peberminta.mjs";
const ws = `(?:[ \\t\\r\\n\\f]*)`;
const nl = `(?:\\n|\\r\\n|\\r|\\f)`;
