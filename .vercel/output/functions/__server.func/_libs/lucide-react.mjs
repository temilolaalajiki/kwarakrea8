...
const FileSpreadsheet = createLucideIcon("file-spreadsheet", __iconNode$p);
const __iconNode$o = [
...
const Film = createLucideIcon("film", __iconNode$o);
const __iconNode$n = [
...
const Navigation = createLucideIcon("navigation", __iconNode$b);
const __iconNode$a = [
  [
    "path",
    {
